    ...
    return (
        <section className='max-w-7xl mx-auto'>
            <div>
               ...
               images generate images through DALL-E AI 
            ...
            <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
             ...
             <div className='mt-5 flex gap-5'>
                ...
                className='text-white bg-green-800 font-medium rounded-md 
                ...
                the image you want,you can share it 
                with others in the community</p>
                <button type='submit' className='mt-3 text-white font-medium rounded-md 
                text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-[#6469ff]'>
